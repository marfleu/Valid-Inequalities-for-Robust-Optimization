# -*- coding: utf-8 -*-
"""
This script contains two evaluation methods, CompareRobustMethods and CompareRobustMethods2. The former executes on one instance all Clique methods considered 
in the thesis and writes the data to a json file. The latter computes original and defaultwithcliques and compares values as non-zero nominal variables,
the robust objective value mainly. All methods can be used automatically on a number of many instances by using the for loop, which scans
...
for file in os.listdir('C:/Users/User/Documents/Masterarbeit'):
    ...
    for file2 in os.listdir('C:/Users/User/Documents/Masterarbeit/data'):
        ...
        if fnmatch.fnmatch(file2, pattern.group(0) + '*'):
            try:
                j+=1
                CompareRobustMethods('C:/Users/User/Documents/Masterarbeit/'+file, 'C:/Users/User/Documents/Masterarbeit/data/' + file2)
                print(file, file2)
                continue
            except:
                continue
