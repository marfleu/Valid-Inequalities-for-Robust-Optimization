...
class MappedQueue(object):
    ...
    def _heapify(self):
        ...
        self.d = dict([(elt[2], pos) for pos, elt in enumerate(self.h)])
    ...
    def update(self, elt):
        ...
        # Replace
        pos = self.d[elt]
        self.h[pos] = (self.h[pos][0]+1, self.h[pos][1], self.h[pos][2])
        # Restore invariant by sifting up, then down
        ...
        while left_pos < end_pos:
            ...
            try:
                ...
                if right[0] < left[0]:
                    ...
                    d[elt[2]], d[right[2]] = pos, right_pos
                else:
                    h[pos], h[left_pos] = left, elt
                    pos, left_pos = left_pos, pos
                    d[elt[2]], d[left[2]] = pos, left_pos
            except IndexError:
