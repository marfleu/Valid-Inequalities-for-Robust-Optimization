...
class ConflictGraph:
    """ Conflict Graph object. Owns all methods to compute Clique Partitions/Clique Covers. Has to be filled by method buildConflictGraph(), which is
        not a method of this object (but probably will be in a future update). 
        ...
        Attributes:
            vartovar: dictionnary; if Conflict Graph is computed with adjacency : var (number) --> row of adjacency matrix
                      ...
                      variable is only used for the algorithms for algorithms, that need a maximal clique (i.e. FindCliqueCover, FindCliquePartitionFromCover)             
            ...
            vartobestclique: dioctionnary; var.VarName --> best clique, i.e. the clique var will be contained in after the application of any Clique Partition/Cover algorithm
